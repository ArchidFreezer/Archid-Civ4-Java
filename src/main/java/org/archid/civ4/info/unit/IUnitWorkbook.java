...
public interface IUnitWorkbook extends IInfoWorkbook {
	...
	public enum SheetHeaders {
		...
		MOVES, UNIT_RANGE_TYPE, NO_REVEAL_MAP, AIR_RANGE, AIR_UNIT_CAP, DROP_RANGE, NUKE_RANGE, WORK_RATE, BASE_DISCOVER, DISCOVER_MULTIPLIER, BASE_HURRY, HURRY_MULTIPLIER, BASE_TRADE, 
		TRADE_MULTIPLIER, GREAT_WORK_CULTURE, ESPIONAGE_POINTS, GREAT_JEST_HAPPINESS, GREAT_JEST_DURATION, TERRAIN_IMPASSABLES, FEATURE_IMPASSABLES, TERRAIN_PASSABLE_TECHS, FEATURE_PASSABLE_TECHS, 
		COMBAT_INT, COMBAT_LIMIT, AIR_COMBAT, AIR_COMBAT_LIMIT, X_P_VALUE_ATTACK, X_P_VALUE_DEFENSE, FIRST_STRIKES, CHANCE_FIRST_STRIKES, INTERCEPTION_PROBABILITY, EVASION_PROBABILITY, 
		WITHDRAWAL_PROB, COLLATERAL_DAMAGE, COLLATERAL_DAMAGE_LIMIT, COLLATERAL_DAMAGE_MAX_UNITS, CITY_ATTACK, CITY_DEFENSE, ANIMAL_COMBAT, HILLS_ATTACK, HILLS_DEFENSE, TERRAIN_NATIVES, 
		FEATURE_NATIVES, TERRAIN_ATTACKS, TERRAIN_DEFENSES, FEATURE_ATTACKS, FEATURE_DEFENSES, UNIT_CLASS_ATTACK_MODS, UNIT_CLASS_DEFENSE_MODS, UNIT_COMBAT_MODS, UNIT_COMBAT_COLLATERAL_IMMUNES, 
		DOMAIN_MODS, BONUS_PRODUCTION_MODIFIERS, YIELDS_FROM_KILL, COMMERCES_FROM_KILL, BOMB_RATE, BOMBARD_RATE, SPECIAL_CARGO, DOMAIN_CARGO, CARGO, CONSCRIPTION, CULTURE_GARRISON, 
		EXTRA_COST, ASSET, POWER, UNIT_MESH_GROUPS, FORMATION_TYPE, HOT_KEY, ALT_DOWN, SHIFT_DOWN, CTRL_DOWN, HOT_KEY_PRIORITY, FREE_PROMOTIONS, LEADER_PROMOTION, LEADER_EXPERIENCE, 
		ORDER_PRIORITY;
