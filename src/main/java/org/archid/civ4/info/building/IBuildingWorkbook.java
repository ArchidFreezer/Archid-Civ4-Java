...
public interface IBuildingWorkbook extends IInfoWorkbook {
	...
	public enum SheetHeaders {
		...
		PREREQ_VICINITY_OR_BONUS, REQUIRE_PREREQ_VICINITY_BONUS_CONNECTED, PREREQ_VICINITY_IMPROVEMENTS, PREREQ_VICINITY_FEATURES, PREREQ_WORLD_VIEWS, MIN_POPULATION, MIN_CULTURE_LEVEL, 
		...
		DOMAIN_FREE_EXPERIENCES, DOMAIN_PRODUCTION_MODIFIERS, BUILDING_CLASS_PRODUCTION_MODIFIERS, BUILDING_HAPPINESS_CHANGES, PREREQ_NUM_OF_BUILDING_CLASSES, PREREQ_AND_BUILDING_CLASSES, 
		PREREQ_OR_BUILDING_CLASSES, PREREQ_NOT_BUILDING_CLASSES, REPLACED_BY_BUILDING_CLASSES, SPECIALIST_YIELD_CHANGES, BONUS_YIELD_MODIFIERS, BONUS_YIELD_CHANGES, VICINITY_BONUS_YIELD_CHANGES, 
		TECH_COMMERCE_CHANGES, IMPROVEMENT_FREE_SPECIALISTS, FLAVORS, HOT_KEY, ALT_DOWN, SHIFT_DOWN, CTRL_DOWN, HOT_KEY_PRIORITY, ORDER_PRIORITY, GRAPHICAL_ONLY;
