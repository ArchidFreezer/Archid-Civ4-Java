...
public interface IBuildingWorkbook extends IInfoWorkbook {
	...
	public enum SheetHeaders {
		...
		REQUIRE_PREREQ_VICINITY_BONUS_CONNECTED, PREREQ_VICINITY_IMPROVEMENTS, PREREQ_VICINITY_FEATURES, PREREQ_WORLD_VIEWS, MIN_POPULATION, MIN_CULTURE_LEVEL, IS_PREREQ_POWER, PRODUCTION_TRAITS, HAPPINESS_TRAITS, NO_BONUS, POWER_BONUS,
		...
		HURRY_COST_MODIFIER, ADVANCED_START_COST, ADVANCED_START_COST_INCREASE, EXTRA_BARBARIAN_COST_CHANGE, BARBARIAN_COST_CONVERSION_MODIFIER, MIN_AREA_SIZE, CONQUEST_PROB, CITIES_PREREQ, TEAMS_PREREQ, LEVEL_PREREQ, MIN_LATITUDE, MAX_LATITUDE, WORKABLE_RADIUS,
		...
		PREREQ_AND_BUILDING_CLASSES, PREREQ_OR_BUILDING_CLASSES, PREREQ_NOT_BUILDING_CLASSES, REPLACED_BY_BUILDING_CLASSES, SPECIALIST_YIELD_CHANGES, BONUS_YIELD_MODIFIERS, VICINITY_BONUS_YIELD_CHANGES, IMPROVEMENT_FREE_SPECIALISTS,
