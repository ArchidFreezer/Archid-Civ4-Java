...
public class EraExporter extends AbstractExporter<IInfos<IEraInfo>, IEraInfo> implements IEraExporter {
	...
	protected Sheet createInfoListSheet() {
		Sheet sheet = wb.createSheet(IEraExporter.SHEETNAME_LIST);
		...
		int colNum = 0;
		for (IEraInfo info : infos.getInfos()) {
	...
	@Override
	protected String getCellMessage(IEraInfo info) {
		return null;
	}
