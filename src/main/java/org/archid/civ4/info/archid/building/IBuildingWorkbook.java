...
public interface IBuildingWorkbook extends IInfoWorkbook {
	...
	public enum SheetHeaders {
		...
		GLOBAL_TRADE_ROUTES, TRADE_ROUTE_MODIFIER, FOREIGN_TRADE_ROUTE_MODIFIER, GLOBAL_POPULATION_CHANGE, FREE_TECHS, DEFENSE, BOMBARD_DEFENSE, ALL_CITY_DEFENSE, ESPIONAGE_DEFENSE, ASSET, POWER,
		...
		PREREQ_OR_BUILDING_CLASSES, PREREQ_NOT_BUILDING_CLASSES, REPLACED_BY_BUILDING_CLASSES, SPECIALIST_YIELD_CHANGES, BONUS_YIELD_MODIFIERS, IMPROVEMENT_FREE_SPECIALISTS, FLAVORS, HOT_KEY, IS_ALT_DOWN,
		IS_SHIFT_DOWN, IS_CTRL_DOWN, HOT_KEY_PRIORITY, ORDER_PRIORITY;
