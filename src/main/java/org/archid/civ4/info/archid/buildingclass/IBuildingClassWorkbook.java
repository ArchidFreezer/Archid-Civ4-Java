package org.archid.civ4.info.archid.buildingclass;
...
public interface IBuildingClassWorkbook extends IInfoWorkbook {
	...
	public enum SheetHeaders {
		TYPE, DESCRIPTION, MAX_GLOBAL_INSTANCES, MAX_TEAM_INSTANCES, MAX_PLAYER_INSTANCES, EXTRA_PLAYER_INSTANCES, NO_LIMIT, MONUMENT, DEFAULT_BUILDING, VICTORY_THRESHOLDS;
